...
class GenerateQuestionsJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            if ($subcategory === 'Word meaning') {
                ...
                if ($variety === 'format_a') {
                    ...
                    $varietyInstruction = "CRITICAL VARIETY RULE: You MUST generate ONLY the following format. You are forbidden from generating any other format:\n        - Format N: Flowchart / Procedural Logic. Provide a procedural logic puzzle based on administrative rules (e.g., tax computation, application routing). You MUST include a clean, scalable SVG diagram (e.g., a flowchart or decision tree) in the question stem to represent the rules. Ensure flowchart connecting lines DO NOT OVERLAP or cross each other to maintain readability. The flowchart MUST be sufficiently complex, containing at least 7 to 10 nodes (boxes/diamonds) and multiple branching decision paths (Yes/No), while keeping the visual layout well-spaced and strictly linear or tree-like to prevent confusing line intersections. Give a specific scenario in the text and ask the user to trace it through the flowchart to find the final output. The options (A to E) MUST be purely text-based.";
                } else {
        ...
        - Format N: Flowchart / Procedural Logic. Provide an SVG flowchart in the question stem representing procedural rules. Ensure connecting lines DO NOT OVERLAP or cross each other. The flowchart MUST contain at least 7 to 10 nodes and multiple branches. Give a specific scenario and ask the user to trace it to the final output. The options MUST be purely text-based.";
                }
        ...
        {$varietyInstruction}
        CRITICAL RULE: You MUST use an SVG for the flowchart diagram in the question stem. You MUST ensure that the connecting lines between flowchart nodes DO NOT OVERLAP or intersect. The flowchart MUST contain at least 7 to 10 nodes (boxes/diamonds) and multiple branching decision paths to ensure realistic complexity. Keep the layout linear or use a simple well-spaced tree structure to prevent visual confusion.
        ...
        CRITICAL SVG RULES: Use a wide viewBox='0 0 800 500' for charts. You MUST leave ample margin inside the viewBox for all axes labels and titles so nothing is clipped. For example, start the chart's main axes at least at x=100 and y=80. Ensure the rotated Y-axis title and the main chart title have plenty of room within positive coordinates. Ensure all text labels use <text> elements with clear font sizes, stay well within the viewBox boundaries, and do not overlap with other visual elements. Keep any SVG code clean, well-structured, and minified without comments. The options should be plain text or numbers based on the data, and the explanation block must reference the specific data points.";
                ...
                $categorySpecificRules = '* Number sequence: Provide challenging mathematical sequence puzzles. To ensure variety, you MUST randomly generate mathematical number sequences using integers, fractions, decimals, or percentages (e.g., 2, 4, 8, 16, _, _ or 0%, 10%, 30%, _, _). You MUST also randomly vary the number of missing terms (blanks) to be either 1 or 2 blanks at the end of the sequence. The logic should strictly involve mathematical patterns (addition, subtraction, multiplication, division, or alternating patterns). ABSOLUTELY NO letter or alphabetical sequences allowed here (those belong in Symbolic logic). DO NOT use letters or non-math symbols (percent signs are allowed).';
                ...
                $categorySpecificRules = '* Code of Conduct and Ethical Standards (R.A. 6713): Test factual knowledge of Republic Act No. 6713. Focus on the 8 Norms of Conduct of Public Officials and Employees, prohibited acts and transactions, rules on receiving gifts, and the filing of the Statement of Assets, Liabilities, and Net Worth (SALN). Ensure questions apply these rules to realistic government workplace scenarios.';
            } elseif ($subcategory === 'Peace and Human Rights Issues and Concepts') {
                $categorySpecificRules = '* Peace and Human Rights Issues and Concepts: Test knowledge of basic human rights principles (UDHR, Philippine constitutional human rights) and peace concepts relevant to the Philippine government. Topics may include fundamental rights, social justice, and state policies on human dignity.';
            } elseif ($subcategory === 'Environment Management and Protection') {
                $categorySpecificRules = '* Environment Management and Protection: Test knowledge of Philippine environmental laws and ecological concepts (e.g., Solid Waste Management Act / R.A. 9003, Clean Air Act, climate change adaptation, and basic environmental conservation principles).';
            }
