...
class GenerateQuestionsJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            if ($subcategory === 'Word meaning') {
                ...
                if ($variety === 'format_a') {
                    ...
                    $varietyInstruction = "CRITICAL VARIETY RULE: You MUST generate ONLY the following format. You are forbidden from generating any other format:\n        - Format N: Flowchart / Procedural Logic. Provide a procedural logic puzzle based on administrative rules (e.g., tax computation, application routing). You MUST include a clean, scalable SVG diagram (e.g., a flowchart or decision tree) in the question stem to represent the rules. Ensure flowchart connecting lines DO NOT OVERLAP or cross each other to maintain readability. Keep the layout simple, well-spaced, and strictly linear or tree-like to prevent confusing line intersections. Give a specific scenario in the text and ask the user to trace it through the flowchart to find the final output. The options (A to E) MUST be purely text-based.";
                } else {
        ...
        - Format N: Flowchart / Procedural Logic. Provide an SVG flowchart in the question stem representing procedural rules. Ensure connecting lines DO NOT OVERLAP or cross each other. Give a specific scenario and ask the user to trace it to the final output. The options MUST be purely text-based.";
                }
        ...
        {$varietyInstruction}
        CRITICAL RULE: You MUST use an SVG for the flowchart diagram in the question stem. You MUST ensure that the connecting lines between flowchart nodes DO NOT OVERLAP or intersect. Keep the layout linear or use a simple well-spaced tree structure to prevent visual confusion. The options (A to E) MUST NOT be SVGs; they must be purely text-based outputs or decisions. Keep the SVG clean and readable. The explanation must map out the deduction step-by-step through the diagram.";
                } else {
