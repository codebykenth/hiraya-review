    ...
    return (
        <PageContainer>
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-6 lg:grid-cols-2">
                {/* AI Generator Card */}
                <div className="relative flex overflow-hidden rounded-2xl border border-border bg-card p-4 shadow-xs transition hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5 sm:p-6">
                    ...
                    <div className="z-10 flex items-start gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Link
                                ...
                                className="group mt-2 block transition-all duration-300 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none active:scale-95"
                            >
                                <Button
                                    type="button"
                                    variant="default"
