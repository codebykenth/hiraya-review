...
export function AdvancedFilters({
    ...
    return (
        <div className="fixed inset-0 z-99 flex animate-in items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs duration-200 fade-in">
            <div
                className="relative max-h-[90vh] w-full max-w-3xl animate-in overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-xl duration-205 zoom-in-95 dark:border-slate-800 dark:bg-slate-950"
                role="dialog"
                aria-modal="true"
            >
                {/* Header */}
