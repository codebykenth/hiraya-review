...
export function AdvancedFilters({
	...
	return (
		<div className="fixed inset-0 z-[99] flex animate-in items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs duration-200 fade-in">
			<div
				className="relative w-full max-w-3xl animate-in rounded-xl border border-slate-200 bg-white shadow-xl duration-205 zoom-in-95 dark:border-slate-800 dark:bg-slate-950 overflow-y-auto max-h-[90vh]"
				role="dialog"
				aria-modal="true"
			>
				{/* Header */}
				<div className="sticky top-0 flex items-center justify-between border-b border-slate-100 bg-slate-50/50 p-6 dark:border-slate-900 dark:bg-slate-900/10">
						...
						<div className="mt-2.5 grid grid-cols-2 gap-2 sm:grid-cols-3">
							{(
								...
								<button
									key={value}
									type="button"
									onClick={() => handleTermsAcceptanceChange(value)}
									className={`rounded-lg border-2 px-3 py-2 text-xs font-bold transition ${
						...
						<div className="grid grid-cols-2 gap-3">
							<div>
								...
								<Input
									...
									onChange={(e) =>
										handleRegistrationDateFromChange(e.target.value)
									}
									className="mt-1.5"
								/>
							</div>
							<div>
								...
								<Input
									...
									onChange={(e) =>
										handleRegistrationDateToChange(e.target.value)
									}
									className="mt-1.5"
								/>
							</div>
						...
						<div className="grid grid-cols-2 gap-3">
							<div>
								...
								<Input
									...
									onChange={(e) => handleLastLoginFromChange(e.target.value)}
									className="mt-1.5"
								/>
							</div>
							<div>
								...
								<Input
									...
									onChange={(e) => handleLastLoginToChange(e.target.value)}
									className="mt-1.5"
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-3">
							<div>
								...
								<Input
									...
									onChange={(e) => handleAttemptsMinChange(e.target.value)}
									placeholder="0"
									className="mt-1.5"
								/>
							</div>
							<div>
								...
								<Input
									...
									onChange={(e) => handleAttemptsMaxChange(e.target.value)}
				...
				{/* Footer Actions */}
				<div className="sticky bottom-0 flex justify-between gap-3 border-t border-slate-100 bg-slate-50/50 p-6 dark:border-slate-900 dark:bg-slate-900/10">
					<Button
						variant="outline"
						size="sm"
						onClick={handleReset}
