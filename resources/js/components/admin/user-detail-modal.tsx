...
export function UserDetailModal({
	...
	const showConfirm = (title: string, message: string, variant: 'danger' | 'success' | 'info', onConfirm: () => void) => {
	...
	return (
		<>
			<div className="fixed inset-0 z-[100] flex animate-in items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs duration-200 fade-in">
				<div
					className="relative w-full max-w-2xl animate-in rounded-xl border border-slate-200 bg-white p-6 shadow-xl duration-205 zoom-in-95 dark:border-slate-800 dark:bg-slate-950 overflow-y-auto max-h-[90vh]"
					role="dialog"
					aria-modal="true"
				>
					{/* Close Button */}
