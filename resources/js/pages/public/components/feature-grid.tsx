...
export default function FeatureGrid({
    ...
    return (
        <div className="grid w-full grid-cols-1 gap-3 sm:gap-6 md:grid-cols-3">
            ...
            >
                <Card className="relative flex h-full w-full flex-col justify-between overflow-hidden border border-slate-200/80 bg-white/70 p-4 py-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5 sm:p-6 sm:py-8 lg:p-8 dark:border-slate-800 dark:bg-slate-950/50">
