...
export function MetricsGrid({ activeStats }: MetricsGridProps) {
    const cardClass = "relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-blue-50/70 via-indigo-50/40 to-slate-50/80 p-5 shadow-sm transition hover:shadow-md dark:border-slate-800 dark:from-slate-900 dark:via-slate-900/80 dark:to-indigo-950/20 backdrop-blur-md";
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <div className={cardClass}>
                ...
                <div className="mt-2.5 flex items-baseline gap-1.5">
                    ...
                    <span className="inline-flex items-center gap-0.5 rounded-full bg-emerald-50 px-2 py-0.5 text-[9px] font-extrabold text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200/30">
