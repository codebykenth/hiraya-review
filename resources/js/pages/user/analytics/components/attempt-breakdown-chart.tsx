...
export function AttemptBreakdownChart({ data }: AttemptBreakdownChartProps) {
    ...
    return (
        <Card className="mb-6 w-full border border-slate-200/80 bg-slate-50/50 p-5 dark:border-slate-800 dark:bg-slate-950/40">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Bar
                                dataKey="Numerical"
                                stackId="a"
                                fill="var(--color-Numerical)"
                                maxBarSize={40}
                            />
                            <Bar
                                dataKey="Analytical"
                                stackId="a"
                                fill="var(--color-Analytical)"
                                radius={[4, 4, 0, 0]}
                                maxBarSize={40}
                            />
                        </BarChart>
