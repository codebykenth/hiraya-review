                                ...
                                <Card className="space-y-4 border border-border bg-card p-6">
                                    ...
                                    <div className="space-y-4 divide-y divide-border">
                                        <div className="space-y-1.5 pt-2">
                                            ...
                                            <span className="mb-4 block text-xs leading-relaxed text-muted-foreground">
                                                All dynamic lessons and test
                                                questions undergo automated and
                                                manual review checks to improve
                                                quality and relevance. Content
                                                is designed to follow commonly
                                                observed Civil Service
                                                Commission (CSC) exam coverage
